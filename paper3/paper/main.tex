...
fully open channel, because the effect saturates on almost no channel access. We add an
...
plain text substitute. \textbf{We did not run it.} It is released as an executable,
resumable notebook alongside the artifact so the experiment is reproducible rather than
merely proposed, and we make no claim about its outcome.
